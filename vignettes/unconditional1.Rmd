---
title: "Spectral backtests of unconditional coverage with alpha2=1"
date: "`r Sys.Date()`"
...
ZZQ <- list( name = 'quadratic/Quadratic',
             type = 'bi',
...
kernlist <- list(ZU=ZU, ZE=ZE, ZLp=ZLp, ZLn=ZLn, ZZhalf=ZZhalf, ZZ1=ZZ1, 
                  ZZ5=ZZ5, ZLL=ZLL, ZAE=ZAE, ZQQ=ZQQ, ZZQ=ZZQ, ZQUQ=ZQUQ)
